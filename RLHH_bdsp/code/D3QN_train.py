...
def get_config(args=None):
    ...
    parser.add_argument('--num_episodes', type=int, default=1, help="number of training episode")
    parser.add_argument('--n_min', type=int, default=50, help="min customers of training instance")
    parser.add_argument('--n_max', type=int, default=60, help="max customers of training instance")
...
for i_episode in range(start_episode, num_episodes):
    ...
    for t in count():
        ...
        if run_mode in ['debug', 'test']:
            print('ep:{}, t:{}, reward:{:.2f}, done:{}, objval:{:.2f}, heuristic:{}, time:{}'.format(
                i_episode+1, t+1, reward, done, info['objval'], info['pricing_strategy'], time.time()-start
                ))
        ...
        if done:
            ...
            print("Episode {:3d}/{}, n: {:2d}, iter: {:3d}, RMP_time: {:.2f}, SP_time: {:.2f}, "
                ...
                ep_reward, ep_loss, env.num_driver, env.best_value, info["gap"]))
            ...
            if run_mode in ['train', 'test'] and i_episode > 0:
                ...
                writer.add_scalar('5_objval', env.best_value, i_episode)
                writer.add_scalar('6_episode_loss', ep_loss, i_episode)
